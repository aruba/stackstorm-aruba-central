...
class PostGroups(ArubaCentralBaseAction):
    def run(self,group_name=None,group_password=None,wired_template=None,wireless_template=None):
        groups = Groups()
        response = groups.create_group(conn=self.auth,
